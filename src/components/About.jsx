...
import stackImage from '../assets/about/younus-avatar.png';
import { aboutContent } from '../data/portfolioData';

// Data Analytics Skill Icons
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <div className="w-16 h-16 md:w-20 md:h-20 bg-black rounded-2xl flex items-center justify-center text-4xl shadow-xl">
      🐍
    </div>
